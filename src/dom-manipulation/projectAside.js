...
export default function createNewProjectForm(buttonNewProject) {
    ...
    const formWrapper = createElement("form", {
    ...
    const cancelButton = buttonWithImg(
...
export function createProjectAside(projectObject) {
    ...
    const divButtonsProjectName = createElement("div", {
    ...
    const allTasksWrapper = createElement("div", {
        elementClass: "project-tasks-aside",
    });

    if (allTasksElements.length === 0) createEmptyHint(allTasksWrapper);
    else
...
export function createTaskElementAside(task) {
    ...
    const spanPriority = createElement("span", {
